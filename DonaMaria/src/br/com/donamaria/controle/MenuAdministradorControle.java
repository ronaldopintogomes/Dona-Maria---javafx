 ...
 * @author Ronaldo
 */
public class MenuAdministradorControle implements Initializable {
    ...
    public void display() {
        ...
        try {
            Parent parent = FXMLLoader.load(getClass().getResource("/br/com/donamaria/visao/fxml/MenuAdministradorFxml.fxml"));
    ...
    @FXML
    private void menuFuncionario(ActionEvent event) {
        MenuFuncionarioControle menuFuncionario = new MenuFuncionarioControle();
